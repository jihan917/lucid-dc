...
function AbbrevHtml ()
    ...
    inoremap <buffer> a<Tab> <a href="">  </a><Esc>5ha
    inoremap <buffer> img<Tab> <img src="" alt="" />
...
autocmd FileType html,xhtml call AbbrevHtml()
